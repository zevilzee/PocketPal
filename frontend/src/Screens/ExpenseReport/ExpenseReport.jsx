...
const ExpenseReport = () => {
  const currentDate = moment().utcOffset("+05:00");
  ...
  const handleDuration = async (time) => {
    ...
    try {
      const res = await axios.get(`${BASE_URL}/expense/get-expense-history`, {
        headers: {
          "auth-token": userState.token,
        },
        params: {
  ...
  return (
    <View style={styles.container}>
      <HeaderTitle title='Expense Report' />
          ...
          <>
            ...
            <View style={styles.todayIncom}>
              <View style={styles.currentIncome}>
                <Text style={styles.incomTitle}>Today Expense</Text>
            ...
            <View>
              ...
              <ExpenseGraph incomeDetails={setincomeDetails} />
            </View>
            {selectedPoint !== null && (
              <View
                style={{
